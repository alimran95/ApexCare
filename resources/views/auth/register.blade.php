                ...
                <div class="row g-0">
                    <div class="col-md-5 left d-flex align-items-center justify-content-center p-4">
                        <div class="text-center">
                            ...
                            <p class="mt-3">Create your account to book appointments and manage your care.</p>
                        </div>
                    </div>
                    <div class="col-md-7 p-4 bg-white">
                        ...
                        <form method="post" action="{{ route('register') }}">
                            ...
                            <div class="text-muted small">Already have an account? <a href="{{ route('login') }}">Sign in</a></div>
                        </form>
                    </div>
                </div>
            </div>
